...
public class GameObjectPool : MonoBehaviour, ISerializationCallbackReceiver {
    ...
    public static LinkedList<GameObjectPool> Instances = new LinkedList<GameObjectPool>();
    ...
    private LinkedListNode<GameObjectPool> node;

    private static Dictionary<GameObject, GameObjectPool> prefabMap = new Dictionary<GameObject, GameObjectPool>();
    ...
    private void RegisterPrefab () {
        if (prefab != null) {
            var existingPool = default(GameObjectPool);
